...
/**
 * Se tiene la siguiente información: · Nombres de 4 empleados. · Ingresos en
 * concepto de sueldo, cobrado por cada empleado, en los últimos 3 meses.
 * Confeccionar el programa para:
 * 
 * a) Realizar la carga de la información mencionada. b) Generar un vector que
 * contenga el ingreso acumulado en sueldos en los últimos 3 meses para cada
 * empleado. c) Mostrar por pantalla el total pagado en sueldos a todos los
 * empleados en los últimos 3 meses d) Obtener el nombre del empleado que tuvo
